...
return [
	...
	'authorize' => false, // enable/disable authorization checks for admin backend
	...
	'routes' => [
		...
		'graphql' => ['prefix' => 'admin/{site}/graphql', 'middleware' => ['web']],
		'jsonadm' => ['prefix' => 'admin/{site}/jsonadm', 'middleware' => ['web']],
		...
		'home' => ['prefix' => 'demo','middleware' => ['web']],
		// 'update' => [],
	],
