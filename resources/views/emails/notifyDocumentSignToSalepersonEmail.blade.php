...
<html>
  <head>
    ...
    <title>Document Sign Notify Mail</title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Dear {{$data['saleperson']}},</p>
                        {{-- <p>We are delighted to welcome you to {{$companyName}} !</p> --}}
                        <p>{{ $data['customer'] }} signs the {{ $data['type'] }} Document from Project: {{ $data['address'] }}</p>
                        {{-- <p>
                        ...
                        <p>
                          <ol>
                            <li>Visit our website at https://designden.sg/.</li>
                            <li>Enter your provided email address and the password and click on the "Login" button.</li>
                        ...
                        <p>
                          ...
                          The Wooden Platform is smooth and enjoyable.
                        </p> --}}
                        <p>
                        ...
                        <p>
                          ...
                          <!-- <span>https://twp.designden.sg/</span><br> -->
                        </p>
                      </td>
                    </tr>
                  </table>
