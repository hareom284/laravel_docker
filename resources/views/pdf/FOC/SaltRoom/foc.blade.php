                            ...
                            <tr>
                                ...
                                @if (!empty($item['items']))
                                    @foreach ($item['items'] as $subItem)
                                        @include('pdf.FOC.SaltRoom.foc_subitems', [
                                            'item' => $subItem,
                                            'level' => 1,
                                        ])
                                    @endforeach
    ...
    <div>
            ...
            @if (count($sortQuotation) != 0)
                @foreach ($sortQuotation as $sectionIndex => $section)
                    <tr>
                        ...
                        <td style="text-align: right; padding-top: 10px;">FOC</td>
                    </tr>
                @endforeach
            @endif
        </table>
        ...
        <table style="width: 50%; margin-left: auto; margin-right: 0;" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="text-align: right; padding-top: 5px; padding-bottom: 5px;">FOC</td>
            </tr>
            <tr>
            ...
            <tr>
                <td
                    ...
                    Sub Total</td>
                <td
                    style="text-align: right; border-top: 1px solid #D3D3D3; border-bottom: 1px solid #D3D3D3; padding-top: 5px; padding-bottom: 5px;">FOC</td>
            </tr>
        </table>
        <br>
        <table style="width: 100%;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td
                    style="text-align: right; padding-top: 5px; padding-bottom: 5px; border-top: 1px solid #D3D3D3; border-bottom: 1px solid #D3D3D3;">FOC</td>
            </tr>
        </table>
        <table style="width: 100%;">
            <tr>
