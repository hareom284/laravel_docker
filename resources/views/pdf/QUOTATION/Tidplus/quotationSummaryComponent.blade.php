<div style="width: 100%; position: relative;">
    ...
    <table class="avoid-break" style="width:100%;position: relative;">
        <tbody class="ft-b-12">
            <tr>
            ...
            <tr>
                ...
                <td style="width: 90px;" align="right">
                    <span style="border-bottom: 0.5px solid black;border-top: 0.5px solid black;">${{ number_format($total_prices['total_inclusive'], 2, '.', ',') }}</span>
                </td>
            </tr>
        </tbody>
    </table>
