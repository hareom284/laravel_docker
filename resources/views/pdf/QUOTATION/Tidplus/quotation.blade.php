    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            for (var i = 0; i < headers.length; i++) {
                ...
                var dynamicDiv = header
                .nextElementSibling; // Get the next sibling which is the div for dynamic height
...
<body style="padding-top: 20px;">
    ...
    <div class="header-section" style="margin-bottom: 20px; padding-right: 85px; padding-left: 85px;">
        <table>
            <tr>
                <td class="ft-12" style="width: 70px;">Date :</td>
                <td class="ft-12">
    ...
    @if (count($sortQuotation) != 0)
        <div style="padding-right: 85px; padding-left: 85px;">
                    ...
                    <div class="section-header"
                        ...
                        @if (isset($item['emptyAOWData']) || count($item['hasAOWData']) != 0)
                            ...
                            @if (getDescription($item['section_id'], $quotationList))
                                <p class="ft-12 italic"
                                    style="margin: 0; padding: 0; font-style: italic;padding-top: 10px;">
                                ...
                                <table border="1"
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                            ...
                                            <tr key="{{ $hasAOW['id'] }}">
                                                <td style="vertical-align: top;width: 15px; padding-left: 50px; padding-right: 5px; margin-right: 5px;"
                                                    align="right" class="ft-12">
                                                    <span>{{ $countIndex }}</span>
                                                </td>
                                                <td style="width: 550px;" class="ft-12">
                                                    <!-- Move the description column -->
                                                ...
                                                <td style="width: 80px;" align="right" class="ft-12">
                                                    <!-- No padding/margin on right-aligned columns -->
                                                ...
                                                @if (!empty($hasAOW['items']))
                                                    ...
                                                    @foreach ($hasAOW['items'] as $subItem)
                                                        ...
                                                        @endphp
                                                        @include(
                                                            'pdf.QUOTATION.Tidplus.quotation_subitems',
                                                            [
                                                                'item' => $subItem,
            ...
            @include('pdf.QUOTATION.Tidplus.quotationSummaryComponent')
