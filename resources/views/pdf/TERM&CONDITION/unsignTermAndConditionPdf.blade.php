        ...
        function replacePlaceholders(
            ...
            if (strpos($content, '{contract_amount_text}') !== false) {
                ...
                if($totalPrices && $totalPrices != 0){
                    ...
                    $content = str_replace('{contract_amount_text}', '', $content);
                }
            }
            ...
            $content = str_replace(
                ...
                [$totalPrices == 0 ? '' : $totalPrices, $customer_names, $project_address, $contract_agreement_number ?? ''],
                $content,
            );
            ...
            if (strpos($content, '{payment_term}') !== false) {
                ...
                if($paymentTerms && !empty($paymentTerms)){
                    ...
                    $content = str_replace('{payment_term}', '', $content);
                    ...
                    @if (!empty($paragraph['is_need_signature']))
                        <div class="signature" align="{{ $paragraph['signature_position'] ?? 'right' }}">
                            @if ($current_folder_name == 'Tag')
                                ...
                                <span>Name Of Client: __________________________</span><br />
                                <span>NRIC No: __________________________</span><br />
                                <span>Date: __________________________ </span><br />
                            @else
                                <div style="height: 100px;"></div>
