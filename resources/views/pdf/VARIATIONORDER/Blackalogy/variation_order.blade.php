                            ...
                            <tr>
                                ...
                                <td>
                                    <table class="amount">
                                        <tr>
                                            <td>$</td>
                                            <td style="text-align: right;"> {{ calculateTotalPrice($item) }} </td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                    ...
                    <tr style="border: 1px solid #000;">
                        ...
                        <td>
                            <table class="amount">
                                <tr>
                                    <td>$</td>
                                    <td style="text-align: right;"> {{ calculateTotalAmountForEachSections($item['section_id'], $quotationList)}} </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr style="border: 1px solid #000;">
                        ...
                        <td>
                            <table class="amount">
                                <tr>
                                    <td>$</td>
                                    <td style="text-align: right;"> {{ number_format($total_prices['total_all_amount'], 2, '.', ',') }} </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr style="border: 1px solid #000;">
                        ...
                        <td>
                            <table class="amount">
                                <tr>
                                    <td>- $</td>
                                    <td style="text-align: right;"> {{ number_format($total_prices['total_all_amount'] - $total_prices['total_special_discount'], 2, '.', ',') }} </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr style="border: 1px solid #000;">
                        ...
                        <td>
                            <table class="amount">
                                <tr>
                                    <td>$</td>
                                    <td style="text-align: right;"> {{ number_format($total_prices['total_special_discount'], 2, '.', ',') }} </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
