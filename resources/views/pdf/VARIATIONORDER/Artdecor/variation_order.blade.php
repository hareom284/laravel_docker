    ...
    <div>
        <div class="header-section">
            <div class="top-header">
                ...
                <div class="right-section text-center" style="padding-top:30px;">
                    ...
                    <div>Tel: (65){{ $quotationData['companies']['tel'] }} Fax :
            ...
            <div class="bottom-header">
                <div class="doc-type">
                    <span class="underline ft-b-16">VARIATION ORDER</span>
                </div>
                <br />
                <div class="detail">
                    <table>
        ...
        <div class="footer-section ft-12 page">
            <div class="footer-detail">
                ...
                <div>
                    We reserve the right to suspend and / or terminate all works for non-payment within the said credit
                    term without
                    advance notice.
                </div>
                <br />
                <div>
                    <span class="ft-b-12">ARTDECOR DESIGN STUDIO PTE LTD</span> (hereunder called the Company) shall
                    have
                ...
                <div>
                    Any alteration or additional works involved and are not included in the specification or description
                    of works,
                </div>
                <div>
                ...
                <div>
                    All the above stated products will remain as the property of Artdecor Design Studio Pte Ltd until
                ...
                <br />
                <div>
                    We trust that the above is in good order and looking forward to your favourable reply. Please do not
