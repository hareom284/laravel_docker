...
<head>
    ...
    <style>
        ...
        .percentage-section th, .percentage-section td, .percentage-section tr {
        ...
        <div class="content-section">
            <div class="content">
                <table border="1" style="border-collapse: collapse; border-color: transparent; width: 100%;"
                    ...
                    @include('pdf.VARIATIONORDER.Brightway.variationSummaryComponent')
                </table>
