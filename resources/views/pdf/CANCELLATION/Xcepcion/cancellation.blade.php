                ...
                <table class="avoid-break" style="width:100%">
                    ...
                    <tbody class="ft-b-12">
                        ...
                        @if ($total_prices['discount_percentage'] != 0)
                            <tr>
                                <td colspan="5" align="right">Total For The Above Mentioned Renovation Works After
                                    Special
                                    Discount :</td>
                                <td style="width: 100px;" align="right">
                        ...
                        @if ($total_prices['gst_percentage'] != 0)
                            <tr>
                                <td colspan="5" align="right">GST ( {{ $total_prices['gst_percentage'] }}% ) :
                                </td>
                                <td style="width: 100px;" align="right">
                        ...
                        @endif
                        <tr>
                            <td colspan="5" align="right">Grand Total For The Above Mentioned Renovation Works
