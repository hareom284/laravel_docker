...
<body>
    ...
    <div class="" style="padding-right: 20px; padding-left: 20px; font-size: 15px;">
        <div>
            ...
            <table style="border-collapse: collapse; border-color:transparent; width: 100%; margin-bottom: 20px;">
                <tr style="margin-top: 0 important;">
                    ...
                    <td style="vertical-align: top;width: 280px; margin-right: 5px; border: 2px solid black; border-right: none; border-left: none; padding: 10px;">
                        <span>Description</span>
                    </td>
                    <td style="width: 50px; text-align:center; border: 2px solid black; border-right: none; border-left: none; padding: 10px;">Contract Price</td>
                    <td style="width: 30px; text-align:center; border: 2px solid black; border-right: none; border-left: none; padding: 10px;">QTY</td>
                    <td style="width: 50px; text-align:center; border: 2px solid black; border-left: none; padding: 10px;">
                        TOTAL
                    </td>
                </tr>
                <tr style="margin-top: 0 important;">
                    <td style="width: 30px; border: 2px solid black; border-right: none; padding: 10px;">1.</td>
                    <td style="vertical-align: top;width: 280px; text-align: left; line-height:20px; padding-left: 50px; margin-right: 5px; border: 2px solid black; border-right: none; border-left: none; padding: 10px;">
                        <span>{{ $description }}</span>
                    </td>
                    <td style="width: 50px;text-align:center; border: 2px solid black; border-right: none; border-left: none; padding: 10px;">$ {{ addCommaToThousand($contractPrice) }}</td>
                    <td style="width: 30px;text-align:center; border: 2px solid black; border-right: none; border-left: none; padding: 10px;">1</td>
                    <td style="width: 50px;text-align:right; border: 2px solid black; border-left: none; padding: 10px;">
                ...
                <tr style="margin-top: 0 important;">
                    ...
                    <td style="vertical-align: top;width: 55px; padding-left: 50px; margin-right: 5px; padding: 5px;"></td>
        ...
        <p style="margin-bottom: 50px;">*Total amount of <span style="font-weight: bold;">Singapore Dollars : SGD {{ addCommaToThousand($amount) }}</span></p>
        <ol style="list-style-type: decimal;">
            <li>Kindly make payment <strong>ASAP (Unless specified above **)</strong> from the date of this invoice. Failing which, interest at 12% per
            ...
            <li>
                ...
                made via bank transfer, please notify us via e-mail to: agnes@techart.com.sg & shalene@techart.com.sg <br/>
