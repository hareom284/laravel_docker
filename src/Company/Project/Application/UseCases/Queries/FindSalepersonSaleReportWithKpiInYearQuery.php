...
class FindSalepersonSaleReportWithKpiInYearQuery implements QueryInterface
{
    ...
    {
        return $this->repository->salepersonSaleReportWithKpiInYear($this->salespersonId,$this->year);
    }
}