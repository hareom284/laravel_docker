...
class FindSalepersonKpiReportMonthQuery implements QueryInterface
{
    ...
    {
        return $this->repository->getSalepersonKpiReportMonth($this->salespersonId,$this->month,$this->year);
    }
}