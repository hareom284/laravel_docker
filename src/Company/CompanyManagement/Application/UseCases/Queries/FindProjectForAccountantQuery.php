...
class FindProjectForAccountantQuery implements QueryInterface
{
    ...
    {
        return $this->repository->getProjectsForAccountant($this->perPage,$this->salePerson,$this->filterText, $this->status, $this->created_at);
    }
}