...
class InactiveCustomerMobileCommand implements CommandInterface
{
    ...
    public function execute(): mixed
    {
        ...
        $customer = $this->repository->inactive($this->user_id);
        if ($customer) {
            $newCustomer = $customer->transition('cancelLead');
